function [step_indices] = fb_step_detection(data_directory, rise_indices, fall_indices, show_plots, export_steps)
...
for rise_i=1:length(rise_indices)
    sequence = accel_filt_z(rise_indices(rise_i):fall_indices(rise_i));
    min_peak_distance = (1/abs(accel_z_cut_freq))*fs / 2;
...
if export_steps
    ...
    writematrix(export_mat, 'step_data_fb.csv');
end
